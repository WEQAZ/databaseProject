...
@section('header')
    <div class="bg-white">
            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        ...
                        <img class="h-8 w-auto" src="upload/images/logo.png" alt="">
                    </a>
                </div>
        ...
        <div class="relative isolate px-0 pt-0 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Empower your online shopping
                        experience</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Discover a world of products at your fingertips, waiting
                        to be explored.</br> Find everything you need and uncover exciting new favorites.</p>
                    ...
                    <h2 class="text-2xl p-10 font-bold tracking-tight text-gray-900"> Scroll down to see more</h2>
                </div>
    ...
    <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
      ...
      <div class="group relative">
        <div class="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80">
          ...
          <img src="{{asset($item->pic)}}" alt="" class="h-full w-full object-cover object-center lg:h-full lg:w-full">
        </div>
