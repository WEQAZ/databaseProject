      ...
      -->
        ...
        <header class="relative bg-white">
            <p class="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
                Get free delivery on orders over $9999</p>
                ...
                <div class="border-b border-gray-200">
                            ...
                            <div class="flex h-full space-x-8">
                                <div class="flex">
                                    <div class="relative flex">
                                        ...
                                        <button type="button" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">IT gadgets</button>
                                    </div>
                  ...
                  -->
                                                ...
                                                <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                                    <div class="col-start-2 grid grid-cols-2 gap-x-8">
                                                        <div class="group relative text-base sm:text-sm">
                                                            <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                                                                <img src="product_data/images/jacket.jpg" alt="Models sitting back to back, wearing Basic Tee in black and bone." class="object-cover object-center">
                                                            </div>
                                                            <a href="#" class="mt-6 block font-medium text-gray-900">
                                                                <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                                                                New Arrivals
                                ...
                                <div class="flex">
                                    <div class="relative flex">
                                        <!-- Item active: "border-indigo-600 text-indigo-600", Item inactive: "border-transparent text-gray-700 hover:text-gray-800" -->
                                        <button type="button" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Fashion&Lifestyle</button>
                                    </div>
                                            ...
                                            <div class="mx-auto max-w-7xl px-8">
                                                <div class="grid grid-cols-2 gap-x-8 gap-y-10 py-16">
                                                    <div class="col-start-2 grid grid-cols-2 gap-x-8">
                                                        <div class="group relative text-base sm:text-sm">
                                                            <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                                                                <img src="product_data/images/jacket.jpg" alt="Drawstring top with elastic loop closure and textured interior padding." class="object-cover object-center">
                                                            </div>
                                                            <a href="#" class="mt-6 block font-medium text-gray-900">
                                                                <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                                                                New Jacket Arrivals
                                                        ...
                                                        <div class="group relative text-base sm:text-sm">
                                                            <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                                                                <img src="product_data/images/airpurifier.jpg" alt="Three shirts in gray, white, and blue arranged on table with same line drawing of hands and shapes overlapping on front of shirt." class="object-cover object-center">
                                                            </div>
                                                            <a href="#" class="mt-6 block font-medium text-gray-900">
                                                                <span class="absolute inset-0 z-10" aria-hidden="true"></span>
                                                                Air purifier
                                                    ...
                                                    <div class="row-start-1 grid grid-cols-3 gap-x-8 gap-y-10 text-sm">
                                                        <div>
                                                            <p id="Clothing-heading" class="font-medium text-gray-900">Food & Drink</p>
                                                            <ul role="list" aria-labelledby="Clothing-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Lunch</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Dragon_fruit</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Matcha</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Sashimi</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Tea</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Water</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Browse All</a>
                                                                </li>
                                                        ...
                                                        <div>
                                                            <p id="Spiritual-Anchor-heading" class="font-medium text-gray-900">Spiritual Anchor</p>
                                                            <ul role="list" aria-labelledby="Spiritual-Anchor-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Daddy</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Sheet1</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Sheet2</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Tonpo</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Win</a>
                                                                </li>
                                                        ...
                                                        <div>
                                                            ...
                                                            <ul role="list" aria-labelledby="Brands-heading" class="mt-6 space-y-6 sm:mt-4 sm:space-y-4">
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Shirt</a>
                                                                </li>
                                                                <li class="flex">
                                                                    <a href="#" class="hover:text-gray-800">Jacket</a>
                                                                </li>
                                                                <li class="flex">
...
-->
                                                    ...
                                                    <div class="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
                                                        ...
                                                        <div>
                                                            <div class="mt-10">
                                                                ...
                                                                <a href="/product" class="inline-block rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-center font-medium text-white hover:bg-indigo-700">Shop
                                                                    Collection</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Spiritual Anchor</a>
                                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Living Things</a>
                                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Food&Drink</a>
                                <a href="#" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Plant&Garden</a>
                        ...
                        <div class="ml-auto flex items-center">
                            ...
                            <div class="hidden lg:ml-8 lg:flex">
                                <a href="#" class="flex items-center text-gray-700 hover:text-gray-800">
                                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Flag_of_Thailand.svg" alt="" class="block h-auto w-5 flex-shrink-0">
